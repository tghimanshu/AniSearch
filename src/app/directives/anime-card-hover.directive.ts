...
import { AnimeCardHoverComponent } from './anime-card-hover/anime-card-hover.component';
import { ComponentPortal } from '@angular/cdk/portal';

@Directive({
  selector: '[animeCardHover]',
})
export class AnimeCardHoverDirective {
  /**
  ...
  @Input(`animeCardHover`) text!: string;
    ...
    const positionStrategy = this._overlayPositionBuilder
      ...
      .withPositions([
        ...
        },
        {
          ...
          overlayY: 'top',
          offsetX: -15,
          panelClass: 'animeCardHoverRight',
        },
      ]);
  ...
  show() {
    ...
    if (this._overlayRef && !this._overlayRef.hasAttached()) {
      const tooltipRef: ComponentRef<AnimeCardHoverComponent> =
        this._overlayRef.attach(new ComponentPortal(AnimeCardHoverComponent));
