...
@Component({
  selector: 'app-anime-card-hover',
  templateUrl: './anime-card-hover.component.html',
  styleUrls: ['./anime-card-hover.component.css'],
})
export class AnimeCardHoverComponent implements OnInit {
  /**
